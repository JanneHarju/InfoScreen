...
using InfoScreenBackend.Models;
using System.Collections.Generic;
using System.Linq;
using System;

namespace InfoScreenBackend.Controllers
{
    ...
    public class InfoController : Controller
    {
        ...
        // PUT api/values/5
        [HttpPut("{id}")]
        public Info Put(int id, [FromBody]Info value)
        {
            ...
            updateInfo.update_info = "Muokattu : " + DateTime.Now.ToShortDateString();
            SaveToFIle(infos);
            return updateInfo;
        }
